...
const TOTALS_REQUEST_OPTIONS = {
    method: 'GET',
    url: 'https://www.sportsbookreview.com/betting-odds/soccer/totals/?leagueId=bundesliga',
    headers: { 'Cache-Control': 'no-cache' }
};

const SPREAD_REQUEST_OPTIONS = {
    method: 'GET',
    url: 'https://www.sportsbookreview.com/betting-odds/soccer/pointspread/?leagueId=bundesliga',
    headers: { 'Cache-Control': 'no-cache' }
};

const ML_REQUEST_OPTIONS = {
    method: 'GET',
    url: 'https://www.sportsbookreview.com/betting-odds/soccer/?leagueId=bundesliga',
    headers: { 'Cache-Control': 'no-cache' }
};
