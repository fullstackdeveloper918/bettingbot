...
const TOTALS_REQUEST_OPTIONS = {
    method: 'GET',
    url: 'https://www.sportsbookreview.com/betting-odds/soccer/totals/?leagueId=champions-league',
...
const SPREAD_REQUEST_OPTIONS = {
    method: 'GET',
    url: 'https://www.sportsbookreview.com/betting-odds/soccer/pointspread/?leagueId=champions-league',
    headers: { 'Cache-Control': 'no-cache' }
};

const ML_REQUEST_OPTIONS = {
    method: 'GET',
    url: 'https://www.sportsbookreview.com/betting-odds/soccer/?leagueId=champions-league',
    headers: { 'Cache-Control': 'no-cache' }
};
